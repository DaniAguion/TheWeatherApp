...
// Si no pasan params, arrancamos en Madrid
const DEFAULT_LOCATION = { name: "Madrid", lat: 40.4168, lon: -3.7038 };

export default function TodayScreen({ navigation, route }: Props) {
  ...
  useFocusEffect(useCallback(() => {
    // Si vuelves desde Ajustes/Favoritos, podrías refrescar si quieres
    return () => {};
  }, []));
